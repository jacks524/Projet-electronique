          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className={`lg:col-span-6 space-y-8 transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/contact" className="inline-flex justify-center items-center px-8 py-4 rounded-xl bg-white text-slate-700 border border-slate-200 font-semibold hover:bg-slate-50 transition-all duration-200">
                  Nous contacter
                </Link>
              </div>
