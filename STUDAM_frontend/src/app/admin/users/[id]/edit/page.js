...
export default function EditUser() {
    ...
    const loadInitialData = async () => {
        try {
            ...
            setFormData({
                ...
                departmentId: userData.departmentNames && userData.departmentNames.length > 0
                    ? deptsData.find(d => d.name === userData.departmentNames[0])?.departmentId || ''
                    : '',
            });
    ...
    const findDepartmentIdByName = (departments, name) => {
        ...
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className="text-center">
                    <svg className="animate-spin h-12 w-12 text-[#F26419] mx-auto mb-4" fill="none" viewBox="0 0 24 24">
                    ...
                    <nav className="flex" aria-label="Breadcrumb">
                        <ol className="flex items-center space-x-4">
                            ...
                            <li className="flex items-center">
                                ...
                                <span className="text-[#F26419] font-medium">Modifier</span>
                            </li>
                        </ol>
                    </nav>
                            ...
                            <div className="border-b border-gray-200 pb-4">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Modifiez le rôle et les accès de l&apos;utilisateur</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="mt-8 bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
                    <div className="flex items-center space-x-3">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900">Points importants</h3>
                    </div>
                </div>
                <div className="p-8">
                    <div className="space-y-4">
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Le mot de passe ne peut pas être modifié via ce formulaire. Utilisez la fonction de réinitialisation de mot de passe pour des raisons de sécurité.
                                </p>
                            </div>
                        </div>
                        <div className="flex items-start space-x-3">
                            <span className="text-2xl">📧</span>
                            <div>
                                <h4 className="font-medium text-gray-900 mb-2">Changement d&apos;email</h4>
                                <p className="text-sm text-gray-600">
                                    Si vous modifiez l&apos;adresse email, assurez-vous d&apos;en informer l&apos;utilisateur car cela affectera sa connexion.
                                </p>
                            </div>
                        </div>
                        <div className="flex items-start space-x-3">
                            <span className="text-2xl">👤</span>
                            <div>
                                <h4 className="font-medium text-gray-900 mb-2">Changement de rôle</h4>
                                <p className="text-sm text-gray-600">
                                    La modification du rôle affectera immédiatement les permissions de l&apos;utilisateur dans le système.
                                </p>
                            </div>
                        </div>
                    </div>
