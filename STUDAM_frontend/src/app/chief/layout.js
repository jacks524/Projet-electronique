...
const Icon = ({ type, className = "w-5 h-5" }) => {
  switch (type) {
    ...
    case 'students':
      return (<svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"/></svg>);
    case 'timetables':
...
export default function ChiefLayout({ children }) {
  ...
  const menuItems = [
    { icon: 'dashboard', label: 'Dashboard', href: '/chief/dashboard' },
    { icon: 'teachers', label: 'Enseignants', href: '/chief/teachers' },
    { icon: 'subjects', label: 'Matieres', href: '/chief/subjects' },
    { icon: 'classes', label: 'Classes', href: '/chief/classes' },
    { icon: 'students', label: 'Etudiants', href: '/chief/students' },
    { icon: 'timetables', label: 'Emplois du temps', href: '/chief/timetables' },
    { icon: 'reports', label: 'Rapports', href: '/chief/reports' },
  ];
